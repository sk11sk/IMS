...
public class ProductTransactionLogDTO {
    ...
    public ProductTransactionLogDTO(Long transactionId, Long productId, Date createdAt, Long quantityChanged,
                                    String transactionType, String barcode, String brand, Double pricePerUnit,
                                    String productName, Long quantity,
                                    Date updatedAt, Long categoryId , String vendorName,String customerName) {
