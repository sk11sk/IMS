...
//                            existingCustomer.getProducts().add(existingProduct);
                            ...
                            if (!existingProduct.getCustomers().contains(existingCustomer)) {
                                existingProduct.getCustomers().add(existingCustomer);
                            }

                            if (!existingCustomer.getProducts().contains(existingProduct)) {
                                existingCustomer.getProducts().add(existingProduct);
                            }



                            Long updatedQuantity = existingProduct.getQuantity()-productDTO.getQuantity();
                           ...
                           double  orderAmount =(existingProduct.getPricePerUnit())*(productDTO.getQuantity());
                            ...
                            productTransactionLog.setVendorOrCustomerId(existingCustomer.getCustomerId());
                        ...
                        productMessage.add("quantity  doesnt exist  for  product :  "+productDTO.getProductName() + "  :   brand  :  " + productDTO.getBrand());
...
//  calculate orderAmount
                            ...
                            productTransactionLog.setQuantityChanged(productDTO.getQuantity());
                            productTransactionLog.setTransactionType("removed");
                            productTransactionLog.setVendorOrCustomerId(savedCustomer.getCustomerId());
                            productTransactionLog.setProduct(existingProduct);
                            existingProduct.getProductTransactionLog().add(productTransactionLog);
                            productTransactionLogRepository.save(productTransactionLog);
                ...
                productMessage.add("product  doesnt exist  "+productDTO.getProductName()+ "    brand    " + productDTO.getBrand());
